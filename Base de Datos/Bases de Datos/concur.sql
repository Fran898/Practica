...
--
-- Host: localhost    Database: concurso2023
-- ------------------------------------------------------
...
CREATE TABLE `canciones` (
  ...
  `titulo` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `componentes` (
  ...
  `nombre` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `apellido` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `alias` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci DEFAULT NULL,
  `funcion` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci DEFAULT NULL,
  `grupo` int NOT NULL,
  PRIMARY KEY (`idComp`),
...
CREATE TABLE `grupos` (
  ...
  `nombre` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `localidad` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `estilo` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `esgrupo` tinyint(1) NOT NULL DEFAULT '1',
  `annoGrab` int DEFAULT NULL,
  `fechaEstreno` date DEFAULT NULL,
  `compania` varchar(35) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  `user` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `contraseña` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `nombre` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `apellidos` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `votos` (
  `usuario` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_spanish_ci NOT NULL,
  `fecha` date NOT NULL,
  `cancion` int NOT NULL,
  PRIMARY KEY (`usuario`,`fecha`),
  KEY `fk_voto_cancion` (`cancion`),
  CONSTRAINT `fk_voto_cancion` FOREIGN KEY (`cancion`) REFERENCES `canciones` (`numCancion`) ON UPDATE CASCADE,
  CONSTRAINT `fk_voto_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`user`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-21 18:50:47
